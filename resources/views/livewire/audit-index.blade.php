...
<div class="animate__animated animate__fadeIn">
    ...
    <div class="mt-2">
        <input wire:model="search" id="search" name="search" type="text" placeholder="Ingrese un dato: Nombre, rol, mail o fecha a buscar" class="ml-10 mb-4 block w-full rounded-md border-0 p-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
    </div>
    @if ($users->count())
                    ...
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">
                                <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" href="{{ route('audit.show', $user->id) }}">Auditar</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
