...
@section('content')
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Nuevo Usuario</h2>
        </div>
            ...
            <div>
                ...
                <div class="m-auto inline-flex">
                    <input type="radio" id="rolUsuario" name="rolUsuario" value="1"
                        class="form-radio h-4 w-4 text-indigo-600 m-auto p-2">
                    <label for="administrador"
                        class="m-auto p-2  text-sm font-medium leading-6 text-gray-900">Administrador</label><br>
                    {{-- </div> --}}
                    {{-- <div class="flex items-center"> --}}
                    <input type="radio" id="rolUsuario" name="rolUsuario" value="2"
                        class="form-radio h-4 w-4 text-indigo-600 m-auto p-2">
                    <label for="vendedor" class="m-auto p-2  text-sm font-medium leading-6 text-gray-900">Vendedor</label>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="m-auto inline-flex">
                    <input type="radio" id="estadoUsuario" name="estadoUsuario" value="1"
                        class="form-radio h-4 w-4 text-indigo-600 m-auto p-2">
                    <label for="activo" class="m-auto p-2  text-sm font-medium leading-6 text-gray-900">Activo</label>
                    {{-- </div> --}}
                    {{-- <div class="flex items-center"> --}}
                    <input type="radio" id="estadoUsuario" name="estadoUsuario" value="2"
                        class="form-radio h-4 w-4 text-indigo-600  m-auto p-2">
                    <label for="inactivo" class="m-auto p-2  text-sm font-medium leading-6 text-gray-900">Inactivo</label>
                </div>
            </div>
            <div>
                <button type="submit"
